...
export default class Embed {
  ...
  footer (text, iconUrl) {
    ...
    this.embed.footer.icon_url = Joi.validate(iconUrl, Joi.string().uri()).error === null ? iconUrl : ''
    return this
  }

  author (name, url, iconUrl, hidden) {
    this.embed.author = this.embed.author || {}
    this.embed.author.name = Joi.validate(toStr(name), Joi.string()).error === null ? name : ''
    this.embed.author.icon_url = Joi.validate(iconUrl, Joi.string().uri()).error === null ? iconUrl : ''
    if (!hidden) {
