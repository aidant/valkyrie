...
export const regex = {
  ...
  hero: /\b(doomfist|genji|mccree|pharah|reaper|soldier:? ?(76)?|sombra|tracer|bastion|hanzo|junk(rat)?|mei|torb(j(o|\u00F6)rn)?|widow(maker)?|dva|orisa|rein(hardt)?|roadhog|winston|zarya|ana|l(u|\u00FA)cio|mercy|sym(metra)?|zen(yatta)?)(?=\s|$)/ig,
