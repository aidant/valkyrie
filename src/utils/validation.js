...
export const regex = {
  ...
  hero: /\b(doomfist|genji|mccree|pharah|reaper|soldier:? ?(76)?|sombra|tracer|bastion|hanzo|junk(rat)?|mei|torb(j(o|\u00F6)rn)?|widow(maker)?|dva|orisa|rein(hardt)?|roadhog|winston|zarya|ana|b(rigitte|agel)|l(u|\u00FA)cio|m(ercy|oth)|sym(metra)?|zen(yatta)?)(?=\s|$)/ig,
